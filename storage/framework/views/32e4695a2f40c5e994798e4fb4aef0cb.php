    ...
    <div class="container mx-auto p-4 sm:p-6 lg:p-8">
        <header class="flex justify-between items-center mb-6">
            ...
            <div class="flex items-center space-x-4">
                <a href="<?php echo e(route('admin.bot_replies.create')); ?>" class="bg-indigo-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md hover:bg-indigo-700 transition-colors">
                    + Tambah Balasan Baru
                </a>
                <!-- Tombol Logout -->
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap font-mono bg-gray-100 px-2 py-1 rounded inline-block"><?php echo e($reply->keyword); ?></p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap"><?php echo e($reply->title); ?></p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <span class="relative inline-block px-3 py-1 font-semibold leading-tight <?php echo e($reply->type == 'info' ? 'text-green-900' : 'text-blue-900'); ?>">
                                <span aria-hidden class="absolute inset-0 <?php echo e($reply->type == 'info' ? 'bg-green-200' : 'bg-blue-200'); ?> opacity-50 rounded-full"></span>
                                <span class="relative"><?php echo e($reply->type); ?></span>
                            </span>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                            <a href="<?php echo e(route('admin.bot_replies.edit', $reply)); ?>" class="text-indigo-600 hover:text-indigo-900 mr-4">Edit</a>
                            <form action="<?php echo e(route('admin.bot_replies.destroy', $reply)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Apakah Anda yakin ingin menghapus balasan ini?');">
                                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\laravel_whatsappbot\whatsapptest-stable\resources\views/admin/bot_replies/index.blade.php ENDPATH**/ ?>